...
@section('content')
    ...
    <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and
        ...
        <a href="https://www.termsfeed.com/live/afa46e8c-1d9c-4d04-9c80-dda406395ede" target="_blank">TermsFeed Privacy Policy Generator</a>.
    </p>
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                &quot;Our&quot; in this Agreement) refers to laravel-chat.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to laravel-chat, accessible from <a href="https://laravel-chat.in"
                    rel="external nofollow noopener" target="_blank">https://laravel-chat.in</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>By email: ziyad199523@gmail.com</li>
    </ul>
@endsection
