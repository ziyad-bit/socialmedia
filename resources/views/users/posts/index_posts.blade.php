                ...
                <div class="card-header card-top">
                    ...
                    <small class="number_comments">
                        <span  style="font-weight: bold"><span
                                class="com_num{{ $post->id }}">{{ $post->comments_count }}</span> comments</span>
                        <span><span class="like_num{{ $post->id }}">{{ $post->likes_count }}</span> likes</span>
                        <span style="font-weight: bold"><span class="share_num{{ $post->id }}">{{ $post->shares_count }}</span>shares</span>
                    </small>
                </div>
                <a class="comment_link" post_id={{ $post->id }}>
                    <div class="card-body  comment_btn" style="background-color:#eee ">
                        ...
                        @if ($post->shares->count() > 0)
                            <i class="fas fa-share  shared_icon" data-post_id="{{ $post->id }}">share</i>
                        @else
                ...
                <div class="card-header card-top">
                    ...
                    <small class="number_comments">
                        <span style="font-weight: bold"><span
                            ...
                            comments</span>
                        <span><span class="like_num{{ $post->id }}">{{ $post->likes_count }}</span> likes</span>
                        <span style="font-weight: bold"><span class="share_num{{ $post->id }}">{{ $post->shares_count }}</span>
                            shares</span>
                    </small>
                </div>
                <a class="comment_link" post_id={{ $post->id }}>
                        ...
                        @if ($post->shares->count() > 0)
                            @foreach ($post->shares as $share)
                                @if ($share->user_id == Auth::id())
                                    <i class="fas fa-share  shared_icon" data-post_id="{{ $post->id }}">share</i>
                                @else
                                    <i class="fas fa-share share share_icon"
